<main>
    <section class="intro">
        <div class="wrapper intro__content">
            ...
            <div>
                <img src="assets/images/isometric.jpg" alt="" class="intro__img">
            </div>   
        </div>   
    </section>
    ...
    <section class="project" id="project">
        <div class="wrapper">
            ...
            <p class="project__text project__text--last">L’objectif de cette application est de sensibiliser les gens aux différentes difficultés que peuvent traverser les malvoyants au quotidien via différentes situations qui peuvent paraître banales pour monsieur ou madame tout le monde.</p>
        </div>
    </section>
