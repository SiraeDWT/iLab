<footer class="footer">
    <div class="footer__content">
        <ul class="footer__list">
            ...
            <li class="footer__el">
                <a href="https://noa-jacquemin.be/">Noa Jacquemin</a>
            </li>
            <li class="footer__el">
                <a href="https://thibault-varga.be/">Thibault Varga</a>
            </li>
            <li class="footer__el">
                <a href="https://eleonore-koterko.be/">Éléonore Koterko</a>
            </li>
            <li class="footer__el">
                <a href="https://xavier-philippe-renk.be/">Xavier-Philippe Renk</a>
            </li>
        </ul>

        <div class="footer__dwt">
            <a href="https://dwt.heaj.be/" class="link__dwt">
                <svg class="dwt" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 71.6 25" style="enable-background:new 0 0 71.6 25" xml:space="preserve">
                    ...
                    <path class="dwt__und" d="M57.69 20.41H71.6V25H57.69z"></path>
                </svg>
            </a>
